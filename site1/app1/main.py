...
df = pd.read_excel(r"app1/machinery.xlsx")

df['Подрядчик'] = df['Подрядчик'].str.strip()

df2 = pd.read_excel("app1/rudnik.xlsx",
...
sql_df = pd.read_excel("app1/from_sql.xlsx")

# Внешний стиль CSS
external_stylesheets = ['https://codepen.io/chriddyp/pen/bWLwgP.css']

app = DjangoDash('main', external_stylesheets=external_stylesheets)
